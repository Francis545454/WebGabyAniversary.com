document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    { question: "Le gusta bts?", answer: true },
    { question: "Su color favorito es el azul?", answer: false },
    { question: "Su animal favorito son los perritos?", answer: true },
    { question: "mide 178,6578m?", answer: false },
    { question: "le gustaria estudiar Turismo?", answer: true }
  ];
  ...
  emoji.addEventListener("click", () => {
    ...
    guideText.textContent = "Carta abierta(Creo)";
...
function loadQuestion() {
    if (currentQuestionIndex >= questions.length) {
        questionContainer.innerHTML = `
            <p>¡Feliz cumple! ¿Cuántas respondiste bien?</p>
        ...
        document.getElementById("btnIniciar").addEventListener("click", () => {
            window.location.href = "cancion.html"; // Cambia por tu URL
        });
